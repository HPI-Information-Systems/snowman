...
import {
    ...
    FileResponseFormat,
    FileResponseFormatFromJSON,
    FileResponseFormatToJSON,
    InlineObject,
...
export class BenchmarkApi extends runtime.BaseAPI {
     ...
     */
    async calculateExperimentIntersectionRecordsRaw(requestParameters: CalculateExperimentIntersectionRecordsRequest): Promise<runtime.ApiResponse<Blob>> {
        if (requestParameters.intersection === null || requestParameters.intersection === undefined) {
     ...
     * intersects multiple experiments and returns the resulting records. This can be used to calculate the confusion-matrix.
     */
    async calculateExperimentIntersectionRecords(requestParameters: CalculateExperimentIntersectionRecordsRequest): Promise<Blob> {
