import InputChipView from 'components/stateful/InputChip/InputChip.View';
import {
  InputChipDispatchProps,
  InputChipOwnProps,
  InputChipStateProps,
} from 'components/stateful/InputChip/InputChipProps';
import {
  changeInputValue,
  ...
  showInput,
  submitValue,
} from 'components/stateful/InputChip/store/InputChipActions';
