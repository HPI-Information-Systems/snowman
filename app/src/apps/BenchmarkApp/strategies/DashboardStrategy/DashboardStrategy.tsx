    ...
    >
      <PageStruct pageTitle={StrategyIDs.Dashboard} enableScroll={true}>
        <IonText color="primary">
          <h3
            data-for="tooltip"
            data-tip="A data steward is responsible for a certain deduplication task (= dataset) within his company. Using Snowman, he aims to compare different matching solutions and to find the most suitable one for his company's use-case."
          >
            Data Stewards
          </h3>
        </IonText>
            ...
            <IonCol size="4" sizeXl="3">
              <IonCard>
                ...
                <IonButton
                  ...
                  fill="clear"
                  onClick={(): void =>
                    openStrategy(StrategyIDs.KpiInvestigator)
                  }
                >
                  Start Benchmark
                </IonButton>
        ...
        <IonText color="primary">
          <h3
            data-for="tooltip"
            data-tip="A developer is responsible for a certain matching solution. His goal is to either develop a new matching solution or to refine an already existing one. For that, Snowman offers multiple investigation strategies upon a matching solution's result set."
          >
            Developers
          </h3>
        </IonText>
            ...
            <IonCol size="4" sizeXl="3">
              <IonCard>
                ...
                <IonButton
                  ...
                  fill="clear"
                  onClick={(): void =>
                    openStrategy(StrategyIDs.NaryIntersection)
                  }
                >
                  Start Benchmark
                </IonButton>
            ...
            <IonCol size="4" sizeXl="3">
              <IonCard>
                ...
                <IonCardContent>
                  <IonText color="dark">
                    <p>
                      <b>Requires:</b> a single experiment with similarity
                      values (or function)
                    </p>
                  </IonText>
                </IonCardContent>
