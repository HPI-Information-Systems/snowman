...
export const ExperimentDialogStoreActionTypes = {
  ...
  OPEN_CHANGE_DIALOG: 'ADD_EXPERIMENT_DIALOG_STORE_ACTION-OPEN_CHANGE_DIALOG',
  ...
  UPDATE_SOFT_KPIS: 'ADD_EXPERIMENT_DIALOG_STORE_ACTION-UPDATE_SOFT_KPIS',
...
export const AlgorithmDialogStoreActionTypes = {
  ...
  UPDATE_SOFT_KPIS_GENERAL: 'ALGORITHM_DIALOG_STORE-UPDATE_SOFT_KPIS_GENERAL',
  UPDATE_SOFT_KPIS_INSTALLATION:
    'ALGORITHM_DIALOG_STORE-UPDATE_SOFT_KPIS_INSTALLATION',
...
export const IntersectionStoreActionTypes = {
  ...
  RESET_INCLUDED_EXPERIMENTS:
    'EXPERIMENT_INTERSECTION_STORE-RESET_INCLUDED_EXPERIMENTS',
  DRAG_N_DROP_EXPERIMENT:
    'EXPERIMENT_INTERSECTION_STORE-DRAG_N_DROP_EXPERIMENT',
...
export const DatasetPreviewerStoreActionTypes = {
  OPEN_DIALOG: 'DATASET_PREVIEWER_STORE-OPEN_DIALOG',
  CLOSE_DIALOG: 'DATASET_PREVIEWER_STORE-CLOSE_DIALOG',
};

export const ExperimentPreviewerStoreActionTypes = {
  OPEN_DIALOG: 'EXPERIMENT_PREVIEWER_STORE-OPEN_DIALOG',
  CLOSE_DIALOG: 'EXPERIMENT_PREVIEWER_STORE-CLOSE_DIALOG',
};
