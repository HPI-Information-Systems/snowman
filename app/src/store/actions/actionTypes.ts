...
export const ExperimentDialogStoreActionTypes = {
  ...
  CHANGE_EXPERIMENT_SOFTKPIS:
    'ADD_EXPERIMENT_DIALOG_STORE_ACTION-CHANGE_EXPERIMENT-SOFTKPIS',
};
...
export const AlgorithmDialogStoreActionTypes = {
  ...
  CHANGE_ALGORITHM_SOFTKPIS: 'ALGORITHM_DIALOG_STORE-CHANGE_ALGORITHM_SOFTKPIS',
