...
export const BenchmarkConfigActionTypes = {
  SET_SELECTED_GOLDSTANDARDS:
    'BENCHMARK_CONFIG_STORE-SET_SELECTED_GOLDSTANDARDS',
  SET_SELECTED_EXPERIMENTS: 'BENCHMARK_CONFIG_STORE-SET_SELECTED_EXPERIMENTS',
  SET_AVAILABLE_EXPERIMENTS: 'BENCHMARK_CONFIG_STORE-SET_AVAILABLE_EXPERIMENTS',
  RESET_CONFIGURATOR: 'BENCHMARK_CONFIG_STORE-RESET_CONFIGURATOR',
  UPDATE_EXPERIMENTS: 'BENCHMARK_CONFIG_STORE-UPDATE_EXPERIMENTS',
};
